...
export default class CaliperMapper {
    ...
    private amountOfPeerGroups: string;
    ...
    async start(caliperConfiguration: CaliperConfiguration, loadBalancerIp: string, benchmarkPath: string, amountOfPeerGroups: string) {
        this.loadBalancerIp = loadBalancerIp;
        this.benchmarkPath = benchmarkPath;
        this.amountOfPeerGroups = amountOfPeerGroups;
    ...
    private addEnvironmentVariables(container: Container) {
        ...
        container.addEnvironmentVariable(new EnvVar("LOAD_BALANCING_AMOUNT_OF_GROUPS", this.amountOfPeerGroups));
    }
