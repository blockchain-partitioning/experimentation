...
class CaliperMapper {
    ...
    start(caliperConfiguration, loadBalancerIp, benchmarkPath, amountOfPeerGroups) {
    ...
    addEnvironmentVariables(container) {
        ...
        container.addEnvironmentVariable(new envvar_1.default("LOAD_BALANCING_AMOUNT_OF_GROUPS", this.amountOfPeerGroups));
    }
