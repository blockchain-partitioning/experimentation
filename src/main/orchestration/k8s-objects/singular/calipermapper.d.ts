...
export default class CaliperMapper {
    ...
    private mountPaths;
    private namespace;
    private amountOfPeerGroups;
    constructor(options: Options);
    start(caliperConfiguration: CaliperConfiguration, loadBalancerIp: string, benchmarkPath: string, amountOfPeerGroups: string): Promise<void>;
